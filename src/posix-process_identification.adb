...
package body POSIX.Process_Identification is
   ...
   function Image (ID : in Process_Group_ID) return Standard.String is
      use Ada;
   begin
   ...
   function Value (Str : in Standard.String) return Process_Group_ID is
   begin
   ...
   function Image (ID : in User_ID) return Standard.String is
      use Ada;
   begin
   ...
   function Value (Str : in Standard.String) return User_ID is
   begin
   ...
   function Image (ID : in Group_ID) return Standard.String is
      use Ada;
   begin
   ...
   function Value (Str : in Standard.String) return Group_ID is
   begin
